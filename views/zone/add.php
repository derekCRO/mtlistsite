		  ...
		  <tr>
			<td bgcolor="#e0e0e0" >
			  <form action="<?php echo $_SERVER_URL; ?>contents/common/ajax_notice_add"
				...
				<tr>
				  <td width="82%" height="40" align="left" bgcolor="#FFFFFF" class="content3" 
					...
					<input type="text" id="title" name="title" placeholder="제목"
						value="<?php echo $info->title; ?>" cols="120" rows="1" style="width:99%;border-radius: 4px;" />
				  </td>
				</tr>
				<tr>
				...
				<tr>
				  <td width="82%" align="left" bgcolor="#FFFFFF" class="content3" 
					style="height: 40px; padding-left:10px;border-right:solid 1px #ddd;border-bottom:solid 1px #ddd;"><table width="90%" border="0" cellspacing="0" cellpadding="0">
					<tr>
