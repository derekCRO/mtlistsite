			  ...
			  <tr>
				<td height="40" bgcolor="#eaeaea" style="border-bottom:1px solid #e2e2e2"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="30%" align="right" class="content3"><?php echo $info->reg_date;?></td>
				...
				<td height="40" bgcolor="#FFFFFF" style="border-bottom:1px solid #e2e2e2"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="38%" align="right" class="content3">
						...
						<?php }?>
						조회수 <strong><?php echo $info->visit_qty;?> </strong>&nbsp;&nbsp;&nbsp;추천수 <strong id="recommend_qty"><?php echo $info->recommend_qty;?> </strong>&nbsp;&nbsp;&nbsp;댓글 <strong><?php echo $info->reply_qty;?></strong></td>
				  </tr>
				</table></td>
			  </tr>
			  <tr>
				<td align="center" class="content3"  style="padding-top:20px; padding-bottom:20px"><p><strong><?php echo nl2br($info->content); ?></strong></p>
			  ...
			  <tr>
				<td height="40" style="border-bottom:1px solid #e2e2e2">
				 ...
				 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td width="50%" idx="<?php echo $info->idx; ?>" id="left_td_<?php echo $info->idx; ?>"
						<?php if($prev_id) { ?>
					...
					<td width="50%" idx="<?php echo $info->idx; ?>"  id="right_td_<?php echo $info->idx; ?>"
						<?php if($next_id) { ?>
...
<script>
	function onnotice_recommend(id){	
		...
		if(write_id == '<?php echo $_SESSION['user_id'];?>'){
