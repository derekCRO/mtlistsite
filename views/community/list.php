...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="80" align="left">
				<?php  // print($type) ;?>
				<img src="<?php echo $_SERVER_URL; ?>images/<?php if($type==13) print('title-exchange.png');
														       else if($type==12) print('title-report.png');
														       else if($type==11) print('title_04.png');
															   else          print('title_03.png');
																	 ?>" height="56">
				</td>
          </tr>
                  ...
                  <tr>
                    ...
                    <td ><img src="<?php echo $_SERVER_URL; ?>images/btn_search.png" 
								align="absmiddle" onClick="searchContents(
										'<?php echo $_SERVER_URL;?>contents/community',
										'<?php echo $type; ?>'
										);" 
