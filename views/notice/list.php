...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td height="80" align="left"><img src="<?php echo $_SERVER_URL; ?>images/title_01.png" width="267" height="56"></td>
  </tr>
		...
		<td height="50" align="center"><table width="0" border="0" align="center" cellpadding="0" cellspacing="3">
		  <tr>
			...
			<img src="<?php echo $_SERVER_URL; ?>images/btn_search.png" 
						...
						'<?php echo $_SERVER_URL;?>contents/notice', 1);" style="cursor:pointer;"></td>
		  </tr>
		</table></td>
	  </tr>
	  <tr>
...
<script>
	...
	_detail_url = '<?php echo $_SERVER_URL; ?>contents/notice/detail';
	_pagination = '<?php echo $_SERVER_URL; ?>contents/notice';
