...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			 <tr>
                <td id ="detail" style="border-bottom: solid 1px #ddd;">
					<?php 
						if($viewdetail)
						{
				...
				<?php 
					//if($type==11 || $type==12 )		//먹튀검증요청 이거나 먹튀신고 게시판 일 때
					{
						include('ajax_list.php'); 
					}
					?>
              ...
              <tr <?php // if( ! isset($_SESSION['user_id']) ) print("style='display:none;'"); ?>  >
                <td height="50" align="right">
					...
					<a href='<?php echo $_SERVER_URL; ?>contents/mtrequest/add?notice_type=<?php echo $type; ?>' >
                  ...
                  <tr>
                    ...
                    <td ><img src="<?php echo $_SERVER_URL; ?>images/btn_search.png" 
								align="absmiddle" onClick="searchContents(
										'<?php echo $_SERVER_URL;?>contents/mtrequest',
										'<?php echo $type; ?>'
										);" 
...
<script>  
	...
	_detail_url = '<?php echo $_SERVER_URL; ?>contents/mtrequest/detail';
	_pagination = '<?php echo $_SERVER_URL; ?>contents/mtrequest';
