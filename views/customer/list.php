...
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td height="80" align="left"><img src="<?php echo $_SERVER_URL; ?>images/title_09.png" width="267" height="56"></td>
  </tr>
	 ...
	 <tr>
	  ...
	  <tr <?php // if( ! isset($_SESSION['user_id']) ) print("style='display:none;'"); ?>  >
		<td height="50" align="right">
			...
			<a href='<?php echo $_SERVER_URL; ?>contents/customer/add?notice_type=<?php echo $type; ?>' >
			...
			<td ><img src="<?php echo $_SERVER_URL; ?>images/btn_search.png" 
						align="absmiddle" 
							onClick="searchContents(
									'<?php echo $_SERVER_URL;?>contents/customer',
									'<?php echo $type; ?>');" style="cursor:pointer;"></td>
		  </tr>
		</table></td>
	  </tr>
	  <tr>
...
<script>  
	...
	_detail_url = '<?php echo $_SERVER_URL; ?>contents/customer/detail';
	_pagination = '<?php echo $_SERVER_URL; ?>contents/customer';
	list_item_select( document.getElementById('list_td_<?php echo $detailid ?>') );
	
	function viewDetailNotice( _url )
	{	//bLogin	<---main login
		//alert(bMustLogin);
		if( !bMustLogin || bIsLogin )
