				...
				<td height="40" bgcolor="#FFFFFF" style="border-bottom:1px solid #e2e2e2"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
				  <tr>
					...
					<td width="38%" align="right" class="content3">
						...
						&nbsp;&nbsp;&nbsp;추천수 <strong id="recommend_qty"><?php echo $info->recommend_qty;?> </strong>&nbsp;&nbsp;&nbsp;댓글 <strong><?php echo $info->reply_qty;?></strong></td>
				  </tr>
				</table></td>
			  </tr>
			  <tr>
				 ...
				 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td width="50%"  id="left_td_<?php echo $info->idx; ?>"
						<?php if($prev_id) { ?>
						onclick="detail(this.id, '<?php echo $prev_id; ?>', '<?php echo $notice_type; ?>');" <?php } ?> style="cursor:pointer;">
						<?php if($prev_id) { ?>
					...
					<td width="50%"  id="right_td_<?php echo $info->idx; ?>"
						  ...
						  <?php } ?> style="cursor:pointer;" align="right">
						 <?php if($next_id) { ?>
